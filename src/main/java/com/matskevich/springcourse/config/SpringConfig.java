package com.matskevich.springcourse.config;
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    /*@Bean
    public JdbcTemplate jdbcTemplate() {        //add db config in jdbcTemplate
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("cpm.matskevich.springcource.models");
